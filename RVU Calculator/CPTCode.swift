...
let cptCodes = [
    ...
    CPTCode(id: 9, code: "99291", description: "Critical care, first 30-74 minutes", profiles: [.hospitalist, .criticalCare], rvusByYear: [2020: 4.50, 2024: 4.50, 2026: 4.50]),
    CPTCode(id: 10, code: "99292", description: "Critical care, each additional 30 minutes", profiles: [.hospitalist, .criticalCare], rvusByYear: [2020: 2.25, 2024: 2.25, 2026: 2.25]),
